...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <li class="nav-link active"><a href="bfm.php">BFM</a></li>
        ...
        <div class="modal-content">
            ...
            <table class="table table-striped table-hover tables">
                ...
                $code=$passcode['Passcode'];
                    ...
                    $displays="select finmastudents.Student_No,finmastudents.fname,finmastudents.initial,finmastudents.lname,finmastudents.sec,finmastudents.GroupCode,portfolio.Buying_Power
                    from finmastudents,portfolio where finmastudents.Student_No=portfolio.Student_No 
                    AND finmastudents.sec='3-BFM' AND finmastudents.GroupCode='$code' ORDER BY portfolio.Buying_Power DESC";
            ...
            <center><h2>BFM Students</h2></center>
